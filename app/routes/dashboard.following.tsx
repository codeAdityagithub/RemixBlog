...
const Following = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center">
      <h2 className="text-2xl font-semibold border-b-2 mb-2 border-border">
        Authors you follow
      </h2>
      <div className="w-full xs:w-[350px] md:w-[400px] lg:w-[500px] overflow-auto ver_scroll flex-1 flex flex-col items-center gap-4">
                ...
                fetcher.submit(
                  {
                    ...
                    isFollowing: `trueT${new Date(createdAt).getTime()}`,
                  },
                  {
                    method: "DELETE",
